...
### Demands (D) vs Wishes (W)

| ID | Requirement | D/W | Value | Remarks |
|----|-------------|-----|-------|---------|
| **FUNCTIONAL** | | | | |
| R01 | Detect aerial targets (drones) | D | 95% @ 300m | Day conditions |
| R02 | Detect ground targets (personnel) | D | 95% @ 500m | Day conditions |
| R03 | Track moving targets | D | Up to 50 m/s | Drone typical speed |
| R04 | Calculate fire solution | D | <100ms latency | Real-time |
| R05 | Gate trigger at optimal moment | D | <5ms precision | For hit optimization |
| R06 | Night operation capability | W | 200m range | IR/thermal |
| R07 | Record engagements | W | 720p video | For training/legal |
| **PERFORMANCE** | | | | |
| R08 | Effective range - drone | D | 250m minimum | 5.56mm platform |
| R09 | Effective range - HMG | W | 400m | 12.7mm platform |
| R10 | Hit probability improvement | D | 3x baseline | Compared to iron sights |
| R11 | First-shot hit probability | W | >70% | Moving target |
| **ENVIRONMENTAL** | | | | |
| R12 | Operating temperature | D | -10°C to +55°C | Vietnam climate |
| R13 | Humidity resistance | D | 95% RH | Monsoon conditions |
| R14 | Dust/water protection | D | IP65 | Field use |
| R15 | Shock resistance | D | MIL-STD-810G | Combat handling |
| **PHYSICAL** | | | | |
| R16 | Handheld weight | D | <1.5 kg | Soldier mobility |
| R17 | RCWS module weight | D | <3 kg | Vehicle integration |
| R18 | Power consumption | D | <10W average | Battery life |
| R19 | Battery life | D | >6 hours | Combat mission |
| **INTEGRATION** | | | | |
| R20 | Mounting interface | D | Picatinny rail | MIL-STD-1913 |
| R21 | Compatible weapons | D | AK/M16/Galil, PKM, NSV, DShK | VPA inventory |
| R22 | MTB-20 integration | D | Full compatibility | Primary platform |
| **PRODUCTION** | | | | |
| R23 | Local content | D | >60% | Self-reliance |
| R24 | COTS components | D | Maximize | Cost efficiency |
| R25 | Unit cost target | W | <$5,000 USD | Export competitive |
| **MAINTENANCE** | | | | |
| R26 | Field-level repair | D | No special tools | Soldier maintenance |
| R27 | MTBF | D | >2,000 hours | Reliability |
| R28 | Software update | D | Field flashable | USB/wireless |
...
| Subfunction | Option A | Option B | Option C | V-SMASH Selection |
|-------------|----------|----------|----------|-------------------|
| **F1.1 Image Capture** | CCD sensor | CMOS sensor | Thermal (LWIR) | **CMOS** (cost, power) + Thermal option |
| **F1.2 Target Detection** | Template matching | Classical CV (HOG+SVM) | Deep Learning (YOLO) | **YOLO-Nano** (accuracy, COTS) |
| **F1.3 Classification** | Rule-based | Random Forest | Neural Network | **Lightweight CNN** (integrated with detection) |
| **F1.4 Range Finding** | Passive (size estimate) | Laser Rangefinder | Stereo vision | **Stereo** (cost) / **LRF** (premium) |
| **F2.2 Tracking** | Centroid tracking | Kalman Filter | Deep SORT | **Kalman Filter** (proven, efficient) |
| **F2.3 Prediction** | Linear extrapolation | Polynomial fit | Constant velocity Kalman | **CV Kalman** (standard) |
| **F3.1 Orientation Sense** | Gyroscope only | Gyro + Accelerometer | Full IMU (9-axis) | **6-axis IMU** (sufficient) |
| **F3.3 Ballistics** | Lookup table | Point-mass 3DOF | 6DOF model | **Point-mass** (efficient) |
| **F4.1 Trigger Sense** | Limit switch | Force sensor | Optical gate | **Force sensor** (proportional) |
| **F5.1/5.2 Trigger Gate** | Mechanical block | Solenoid | Servo motor | **Solenoid** (speed) |
| **F6.1 Aim Display** | Projected reticle | LCD overlay | See-through optic | **See-through** (simple, reliable) |
| **F6.3 Fire Indicator** | LED only | Audio only | LED + Audio | **LED + Audio** (redundant) |
| **F_AUX.1 Power** | AA batteries | Rechargeable Li-ion | External power | **Li-ion 18650** (capacity) |
| **F_AUX.2 Recording** | Internal memory | SD card | Cloud upload | **SD card** (field practical) |
| **F_AUX.5 Fail-safe** | Manual bypass switch | Auto-detect failure | Mechanical decouple | **Auto + Manual** (defense in depth) |
...
└──────────────────┘   └──────────────────┘   └──────────────────┘
         ...
         ▼                       ▼                       ▼
┌──────────────────┐   ┌──────────────────┐   ┌──────────────────┐
│   TARGET WEAPONS │   │   TARGET WEAPONS │   │   TARGET WEAPONS │
│ • AK-47/AKM      │   │ • M16/M4        │   │ • NSV 12.7mm    │
│ • M16A2/M4       │   │ • Galil         │   │ • DShK 12.7mm   │
│ • Galil          │   │ • Designated MR │   │ • PKT 7.62mm    │
│ • Type 56        │   │ • PKM           │   │ • KORD 12.7mm   │
└──────────────────┘   └──────────────────┘   └──────────────────┘
```
...
## 4.3 V-SMASH-PRO Specification

```yaml
variant: "V-SMASH-PRO"
designation: "V-SMASH-P"
purpose: "Extended range, day/night counter-drone"

physical:
  weight: "<1.8 kg (with battery)"
  dimensions: "200 x 90 x 120 mm"
...
optical:
  ...
  field_of_view: "8°"
  eye_relief: "90mm"
  reticle: "Etched mil-dot + electronic"
...
sensors:
  day:
    ...
    frame_rate: "60 fps"
  night:
    type: "Uncooled thermal (LWIR)"
    resolution: "640x480"
    NETD: "<50mK"
    frame_rate: "30 fps"
  rangefinder:
    type: "Laser (1550nm, eye-safe)"
    range: "50-1000m"
    accuracy: "±1m"

processing:
  platform: "NVIDIA Jetson Xavier NX"
  ai_model: "YOLOv8-small (multi-spectral)"
  tracking: "Deep SORT"
  fusion: "Day + thermal overlay"
  latency: "<40ms"

power:
  battery: "Custom Li-ion pack, 50Wh"
  voltage: "11.1V nominal"
  consumption: "8W average"
  runtime: ">6 hours"
  charging: "Dedicated charger, 3 hours"

performance:
  detection_range:
    drone_small: "500m (day), 400m (night)"
    drone_medium: "800m (day), 600m (night)"
    person: "600m (day), 500m (night)"
  tracking_speed: "80 m/s max"
  hit_improvement: "4x vs iron sights"

compatibility:
  weapons:
    - "Designated marksman rifles"
    - "Light machine guns (PKM, M240)"
    - "Sniper rifles (up to .338)"
  trigger_interface: "Configurable mechanical/electronic"
...
## 4.4 V-SMASH-RWS Specification

```yaml
variant: "V-SMASH-RWS"
designation: "V-SMASH-R"
purpose: "MTB-20 RCWS integration, counter-UAS"

physical:
  weight: "<3 kg (module only)"
  dimensions: "250 x 150 x 120 mm"
  mounting: "Custom MTB-20 bracket"
  material: "Aluminum + steel structure"
  protection: "IP67, EMI shielded"

sensors:
  day:
    type: "CMOS color, global shutter"
    resolution: "1920x1080"
    frame_rate: "120 fps"
    zoom: "10x optical"
  night:
    type: "Cooled MWIR thermal"
    resolution: "640x512"
    NETD: "<30mK"
    frame_rate: "60 fps"
  rangefinder:
    type: "Laser (1064nm, military)"
    range: "100-3000m"
    accuracy: "±1m"

processing:
  platform: "NVIDIA Jetson AGX Orin"
  ai_model: "YOLOv8-large + tracking"
  tracking: "Multi-target (up to 10)"
  fusion: "Full sensor fusion"
  latency: "<30ms"

power:
  source: "Vehicle power (28V DC)"
  consumption: "50W average"
  backup: "Internal UPS, 10 minutes"

fire_control:
  trigger: "Electronic (MTB-20 native)"
  modes:
    - "Manual (AI assist display)"
    - "Semi-auto (AI aim correction)"
    - "Auto-track (human authorize)"
  anti_drone:
    - "Swarm tracking"
    - "Priority targeting"
    - "Burst fire mode"
...
integration:
  mtb20_interface:
    servo_control: "CAN bus"
    trigger: "24V electronic"
    video: "Ethernet (GigE Vision)"
    status: "RS-422"
  c4i:
    protocol: "Link-16 compatible"
    data: "Target sharing"
...
performance:
  detection_range:
    ...
    drone_medium: "1000m"
    vehicle: "2000m"
  tracking_speed: "100 m/s max"
  engagement_rate: "10 targets/minute"
  hit_probability: ">80% (drone @ 400m)"

cost_target:
  unit_cost: "<$25,000 USD"
  local_content: ">40%"
```
...
## 5.3 Criteria and Weights

| ID | Criterion | Weight | Justification |
|----|-----------|--------|---------------|
| C1 | Technical Performance | 15% | Core capability matters |
| C2 | Reliability | 10% | Combat critical |
| C3 | Development Cost | 15% | Budget constrained |
| C4 | Production Cost | 10% | Volume production target |
| C5 | Development Time | 10% | Urgency for capability |
| C6 | Supply Chain Risk | 15% | Self-reliance priority |
| C7 | Local Capability Match | 15% | Technology transfer goal |
| C8 | Maintainability | 5% | Long-term support |
| C9 | Interoperability | 5% | System integration |
| C10 | Upgrade Path | 0% | Included in C7 |
| **TOTAL** | | **100%** | |
...
| Criterion | V1: Clone | V2: Local-First | V3: Hybrid | V4: Phased |
|-----------|-----------|-----------------|------------|------------|
| C1: Performance | 4 | 2 | 3 | 3 |
| C2: Reliability | 3 | 2 | 3 | 3 |
| C3: Dev Cost | 1 | 3 | 3 | 4 |
| C4: Prod Cost | 1 | 4 | 3 | 3 |
| C5: Dev Time | 1 | 3 | 2 | 4 |
| C6: Supply Chain | 1 | 4 | 3 | 3 |
| C7: Local Match | 1 | 4 | 3 | 4 |
| C8: Maintain | 2 | 4 | 3 | 3 |
| C9: Interop | 3 | 2 | 3 | 3 |
...
1. **Risk Mitigation**: Start with achievable scope, prove capabilities
2. **Capability Growth**: Each phase adds performance
3. **Learning Integration**: Lessons from Phase 1 inform Phase 2
4. **Budget Alignment**: Spread investment over time
5. **Local Expertise Building**: Gradual capability development

### Phased Roadmap

```
PHASE 1: V-SMASH-LITE Core (12 months)
├── Basic CMOS sensor integration
├── Classical CV detection (simpler than deep learning)
├── Kalman tracking implementation
├── Basic ballistic computer
├── Manual trigger (no gating)
└── Deliverable: Aiming aid prototype

PHASE 2: AI Integration (12 months)
├── Train YOLO model on local dataset
├── Upgrade to Jetson Nano
├── Add trigger gating mechanism
├── Extended testing and validation
└── Deliverable: V-SMASH-LITE production unit

PHASE 3: V-SMASH-PRO Development (12 months)
├── Add thermal sensor fusion
├── Integrate laser rangefinder
├── Enhanced AI (Deep SORT tracking)
├── Night operations validation
└── Deliverable: V-SMASH-PRO production unit

PHASE 4: V-SMASH-RWS Integration (12 months)
├── MTB-20 integration package
├── Multi-target tracking
├── Anti-drone mode development
├── C4I integration
└── Deliverable: V-SMASH-RWS production unit
```
...
│  ┌────────────────────────────────────────────────────────────┐ │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────────┐ │ │
│  │  │ Fire Control │  │   Operator   │  │  Configuration   │ │ │
...
│  ┌────────────────────────────────────────────────────────────┐ │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────────┐ │ │
│  │  │    YOLO      │  │   Kalman     │  │    Ballistic     │ │ │
│  │  │  Detector    │  │   Tracker    │  │    Computer      │ │ │
│  │  │  (TensorRT)  │  │   (OpenCV)   │  │    (Custom)      │ │ │
│  │  └──────────────┘  └──────────────┘  └──────────────────┘ │ │
│  └────────────────────────────────────────────────────────────┘ │
│                              │                                   │
│  MIDDLEWARE LAYER            │                                   │
...
## 6.3 Bill of Materials (V-SMASH-LITE)
...
│                   │                   │                   │                  │
▼                   ▼                   ▼                   ▼
V-SMASH-LITE        V-SMASH-LITE        V-SMASH-PRO         V-SMASH-RWS
Prototype           Production          Production          Production
```
...
|---------|------|--------|---------|
| 1.0 | 2026-01-18 | @interventionist | Initial release |

---

*Generated by RE Agent Team - V-SMASH Conceptual Design*
*Based on SMASH FCS Reverse Engineering Analysis (Session SMASH-FCS-20260118)*
